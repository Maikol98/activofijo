...
class CreateRevaluoMantenimientoPage extends StatefulWidget {
  @override
  _CreateTranferenciaState createState() => _CreateTranferenciaState();
}

class _CreateTranferenciaState extends State<CreateRevaluoMantenimientoPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final RevisionMantenimiento revision = ModalRoute.of(context).settings.arguments;
